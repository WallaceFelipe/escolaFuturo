...
-- -----------------------------------------------------
-- Table `escolafuturo`.`diciplina`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `escolafuturo`.`diciplina` ;

CREATE TABLE IF NOT EXISTS `escolafuturo`.`diciplina` (
...
CREATE TABLE IF NOT EXISTS `escolafuturo`.`turma` (
  ...
  `diciplina_codigo` VARCHAR(10) NOT NULL,
  `professor_idprofessor` INT NOT NULL,
  `horario` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idturma`),
  INDEX `fk_turma_diciplina_idx` (`diciplina_codigo` ASC),
  INDEX `fk_turma_professor1_idx` (`professor_idprofessor` ASC),
  UNIQUE INDEX `un_turma` (`diciplina_codigo` ASC, `professor_idprofessor` ASC, `horario` ASC),
  CONSTRAINT `fk_turma_diciplina`
    FOREIGN KEY (`diciplina_codigo`)
    REFERENCES `escolafuturo`.`diciplina` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `escolafuturo`.`avaliacao` (
  ...
  `turma_diciplina_codigo` VARCHAR(10) NOT NULL,
  `turma_professor_idprofessor` INT NOT NULL,
  `status` INT(1) NULL,
  PRIMARY KEY (`idavaliacao`),
  INDEX `fk_avaliacao_turma1_idx` (`turma_diciplina_codigo` ASC, `turma_professor_idprofessor` ASC),
  CONSTRAINT `fk_avaliacao_turma1`
    FOREIGN KEY (`turma_diciplina_codigo` , `turma_professor_idprofessor`)
    REFERENCES `escolafuturo`.`turma` (`diciplina_codigo` , `professor_idprofessor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `escolafuturo`.`questao` (
  ...
  INDEX `fk_questao_diciplina1_idx` (`diciplina_codigo` ASC),
